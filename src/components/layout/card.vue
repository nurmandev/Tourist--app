...
<template>
  ...
  :enter="{
   ...
   :class="[
    'card relative bg-white rounded-lg shadow',
  ...
  <span 
    v-if="card.label" 
    :class="['text-xs mt-3 block', card.label === 'original' ? 'bg-primary-gray flex items-center px-2 py-2 rounded-2xl font-bold' : 'text-gray-500']"
  >
